...
degree = 3
feature_0_poly = PolynomialFeatures(degree).fit_transform(feature_0)
feature_1_poly = PolynomialFeatures(degree).fit_transform(feature_1)
feature_2_poly = PolynomialFeatures(degree).fit_transform(feature_2)
feature_3_poly = PolynomialFeatures(degree).fit_transform(feature_3)
...
k_fold = 8
lamb = 0.0001
print('sklearn k-fold: ', k_fold, 'polynomial degree: ', degree, 'lambda:', lamb)
...
test_0_poly = PolynomialFeatures(degree).fit_transform(test_0)
test_1_poly = PolynomialFeatures(degree).fit_transform(test_1)
test_2_poly = PolynomialFeatures(degree).fit_transform(test_2)
test_3_poly = PolynomialFeatures(degree).fit_transform(test_3)
...
create_csv_submission(id_test, label_test, 'submission_test.csv')